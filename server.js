 // server.js const WebSocket = require("ws"); const PORT = process.env.PORT || 8080; const wss = new WebSocket.Server({ port: PORT });         /**  * Lista de pontos de spawn predefinidos.  * Cada ponto tem uma posição (pos) e uma rotação (rot).  */
 const spawnPoints = [
